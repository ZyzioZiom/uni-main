...
<div id="content">
  <div class="col-md-10 centered heading fontcolor">
     <div class="logo text-center"></div>
      <br/>
      <h3 class="text-center"><strong>Cennik warsztatów</strong></h1>
  </div>
  
  <div class="col-md-4 col-md-offset-4 centered about fontcolor" style="font-size: 18px;">
    
    <table class="table">
    <tr>
      <strong>Ceny podstawowe</strong>
    </tr>
    <tr>
    ...
    <table class="table">
    <tr>
      <strong>Przy zapisie na więcej niż jedne zajęcia</strong>
    </tr>
    <tr>
      <td>Dwa kursy grupowe</td>
      <td>259 zł</td>
    </tr>
    <tr>
      <td>Dwa kursy indywidualne</td>
      <td>699 zł</td>
    </tr>
    </table>
