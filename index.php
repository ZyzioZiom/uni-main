...
<html lang="pl">
  <head>
    ...
    <link rel="image_src" href="http://aiesec.pl/uni/img/facebook-thumbnail.jpg">
    <meta charset="utf-8">
...
<div class="row">
  <div class="col-md-10 col-md-offset-1 fontface fontcolor" style="padding-top: 40px;">
    <h2 class="text-center" style="padding-bottom: 40px;">Tylko 199 zł za 5 tygodni warsztatów</h2>
...
<div class="row">  
  <div class="col-md-6 col-md-offset-3 centered text-centered bottom-buttons">
    <a href="signup.php"><div class="col-md-5 btn btn-danger">ZAPISZ SIĘ</div></a>
